<template>
  <div
    class="flex h-14 w-full flex-col justify-center rounded-lg p-2 md:h-24 md:p-4"
...
<script>
import { debounce, getContrast } from '../../utils'

export default {
  name: 'ThemeStyleSwatch',
