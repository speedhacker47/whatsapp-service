<div class="relative">
    <div class="container mx-auto  sm:py-12">
        <div class="max-w-2xl mx-auto space-y-8">
            {{-- Profile Card --}}
            <x-card class="rounded-2xl overflow-hidden">
                {{-- Gradient Header --}}
                <div class="h-1 w-full bg-gradient-to-r from-primary-500 to-purple-600"></div>
                <x-slot:content class="p-8 relative">
                    {{-- Profile Header --}}
                    <div
                      ...
                      : asset('img/user-placeholder.jpg') }}" alt="{{ $user->firstname }} {{ $user->lastname }}"
                            ...
                            <span
                                ...
                                {{ $user->is_admin ? 'Admin' : $user->getRoleNames(tenant_id())->first() }}
                            </span>
                            @endif
                        </div>
